...
- `arbitration_agent`：实现负责人、调用/理解方
...
1. 阶段0：冻结公共契约、字段和联合决策状态机
2. 阶段1：用Mock跑通学习会话与决策轮次
3. 阶段2：接入知识工程结果与检索上下文
4. 阶段3：接入诊断和路径智能体
5. 阶段4：接入资源和测评智能体
6. 阶段5：实现审核、仲裁、重试与人工介入
7. 阶段6：完整集成、性能和回归
8. 阶段7：发布、演示与答辩
...
```text
你正在完成挑战杯项目中“项目负责人、总架构、编排与仲裁”相关任务。必须遵守以下规则：
1. 只修改任务卡允许的目录：services/orchestrator/**, services/arbitration/**, services/session/**, contracts/**, project/**, docs/**。
