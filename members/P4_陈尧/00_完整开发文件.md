...
18. `api/openapi.yaml`
19. `mocks/http/index.yaml`
20. `project/boundary_contract_manifest.yaml`
...
1. 阶段0：冻结页面地图、展示模型和图表字段
2. 阶段1：建立前端骨架、请求层和Mock页面
3. 阶段2：知识质量、图谱和引用可视化
4. 阶段3：画像和学习路径可视化
5. 阶段4：资源和测评展示审核
6. 阶段5：时间线、分歧、证据链和仲裁可视化
7. 阶段6：指标看板与演示图表
8. 阶段7：演示与答辩素材
...
```text
你正在完成挑战杯项目中“前端架构、联合决策可视化与评测分析”相关任务。必须遵守以下规则：
1. 只修改任务卡允许的目录：apps/web/**, contracts/typescript/**, mocks/**, docs/**。
